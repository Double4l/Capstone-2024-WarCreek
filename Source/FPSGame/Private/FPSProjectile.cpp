...
void AFPSProjectile::OnHit(UPrimitiveComponent* HitComp, AActor* OtherActor, UPrimitiveComponent* OtherComp, FVector NormalImpulse, const FHitResult& Hit)
{
	...
	if ((OtherActor != NULL) && (OtherActor != this) && (OtherComp != NULL) && OtherComp->IsSimulatingPhysics())
	{
		...
		OtherComp->AddImpulseAtLocation(GetVelocity() * 100.0f, position);

		//CALL SetRandomColor() Pass In OtherComp, FLinearColor::MakeRandomColor()
		NMC_SetRandomColor(OtherComp, FLinearColor::MakeRandomColor());
		//CALL SetScale, Pass in OtherActor, OtherComp
		NMC_SetScale(OtherActor, OtherComp);
...
void AFPSProjectile::Server_ApplyImpulse_Implementation(UPrimitiveComponent* OtherComp, FVector position)
{
...
void AFPSProjectile::NMC_SetScale_Implementation(AActor* OtherActor, UPrimitiveComponent* OtherComp)
{
...
void AFPSProjectile::NMC_SetRandomColor_Implementation(UPrimitiveComponent* OtherComp, FLinearColor color)
{
	...
	UMaterialInstanceDynamic* MatInst = OtherComp->CreateAndSetMaterialInstanceDynamic(0); // got en error?
